...
if __name__ == '__main__':
    ...
    parser.add_argument('ms', type=str, help='A MeasurementSet containing the relevant phase centre.')
    parser.add_argument('box_size', type=float, default=2.5, help='Size of the sides of the subtract box in degrees.')
